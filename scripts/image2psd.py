...
def write_psd(
    ...
    # PSD layer records are written bottom-to-top for Photoshop-compatible
    # stacking. The manifest and CLI already provide layers in bottom-to-top
    # order, matching the preview compositor and saved PNG layer sequence.
    for layer in layers_bottom_to_top:
